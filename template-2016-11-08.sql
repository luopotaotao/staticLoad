...
CREATE TABLE `b_area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='行政区划';
...
-- Records of t_online
-- ----------------------------
INSERT INTO `t_online` VALUES ('211d3395-0a68-49af-8b46-aa00690edb5c', '127.0.0.1', '2016-11-08 16:53:15', 'admin');
...
CREATE TABLE `t_user` (
  ...
  `dept_id` int(11) DEFAULT NULL COMMENT '所属公司',
  `role` enum('2','1','0') CHARACTER SET utf8mb4 DEFAULT '2' COMMENT '超级管理员,公司管理员,普通用户',
  PRIMARY KEY (`ID`),
