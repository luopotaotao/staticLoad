...
public class TSystemConfig implements java.io.Serializable
{
     ...
     */
    private static final long serialVersionUID = 2374170015900765882L;
    ...
    /** minimal constructor */
    public TSystemConfig(String confId, String confName, Date updateTime, String adminName,
                         Short dataVerFalg)
    {
        this.confId = confId;
    ...
    /** full constructor */
    public TSystemConfig(String confId, String confName, String confContext, String confDesc,
