...
public class RoleController extends BaseController
{
    ...
    {
        this.getSessionInfo().getResourceList().add("/roleController/treeGrid.action");
        this.getSessionInfo().getResourceMap().put("/roleController/treeGrid.action", "角色表格");
    ...
    public String addPage(HttpServletRequest request)
    {
        ...
        this.getSessionInfo().getResourceList().add("/roleController/add.action");
        this.getSessionInfo().getResourceMap().put("/roleController/add.action", "角色添加功能");
        ...
        throws Exception
    {
        ...
        {
            this.getSessionInfo().getResourceList().add("/roleController/edit.action");
            this.getSessionInfo().getResourceMap().put("/roleController/edit.action", "角色编辑功能");
            request.setAttribute("role", r);
        ...
        throws Exception
    {
        ...
        {
            this.getSessionInfo().getResourceList().add("/resourceController/allTree.action");
            this.getSessionInfo().getResourceMap().put("/resourceController/allTree.action",
                "角色授权-资源下拉列表");
            this.getSessionInfo().getResourceList().add("/roleController/grant.action");
            this.getSessionInfo().getResourceMap().put("/roleController/grant.action",
                "角色授权功能");
            request.setAttribute("role", r);
