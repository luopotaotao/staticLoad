    ...
    <form id="ff" class="easyui-form" method="post" data-options="novalidate:true" action="${baseUrl}/post.action">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="code" style="width:100%"
                   data-options="label:'工程编码:',required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="name" style="width:100%"
                   data-options="label:'工程名称:'">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="province_id" style="width:100%"
                   data-options="label:'所在省份:'">
        </div>
        <div>
            <input class="easyui-textbox" name="city_id" style="width:100%"
                   data-options="label:'所在市:'">
        </div>
        <div>
            <input class="easyui-textbox" name="address" style="width:100%"
                   data-options="label:'具体地址:'">
        </div>
        <div style="margin-bottom:20px">
        ...
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="constructor_id" style="width:100%"
                   data-options="label:'建设单位:'">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="builder_id" style="width:100%"
                   data-options="label:'施工单位:'">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="inspector_id" style="width:100%"
                   data-options="label:'监理单位:'">
        </div>
        <div style="margin-bottom:20px">
            <input name="inspector_id" class="easyui-textbox select" style="width:100%"
                   data-options="label:'监理单位:',required:true,buttonText:'选择',
...
//            width: 700,
        ...
        function selectChild(url, callback) {
            var $div = $('<div id="123" style="width: 40%;height: 100%"/>');
            $div.dialog({
                title: '请选择',
                closed: false,
                cache: true,
