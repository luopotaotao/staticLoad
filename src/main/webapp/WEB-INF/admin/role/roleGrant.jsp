...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree')
				.tree(
						{
							url : '<c:url value="/resourceController/allTree"/>',
							parentField : 'pid',
							//lines : true,
		...
		$('#form')
				.form(
						{
							url : '<c:url value="/roleController/grant"/>',
							onSubmit : function() {
								...
								parent.$.messager.progress('close');
									...
									if (result.success) {
										parent.$.modalDialog.openner_treeGrid
												.treegrid('reload');//之所以能在这里调用到parent.$.modalDialog.openner_treeGrid这个对象，是因为role.jsp页面预定义好了
