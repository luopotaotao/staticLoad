...
<script type="text/javascript">
	$(function() {
		...
		$("#moneyType").val("${favorable.moneyType}");
		...
		$('#favorableEditForm')
				.form(
						{
							url : '${pageContext.request.contextPath}/favorableController/edit.action',
							onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false"
		...
		<form id="favorableEditForm" method="post">
			<table class="tableForm">
				<tr>
					<th style="width: 100px;">优惠名称</th>
					<td><input type="hidden" name="dataVerFalg"
						value="${favorable.dataVerFalg}" /><input type="hidden"
						name="favouableId" value="${favorable.favouableId}" /><input
						name="favouableName" type="text" class="easyui-validatebox"
						data-options="required:true,validType:['NO_SPACE']" maxlength="50"
						value="${favorable.favouableName}" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="favouableThreshold" type="text"
						value="${favorable.favouableThreshold}" id="favouableThreshold"
				...
				<tr>
					...
					<td><input name="favouableContent" type="text"
						class="easyui-validatebox"
						data-options="required:true,validType:['NUMNOZERO']" maxlength="6"
						value="${favorable.favouableContent}"><span id="span">单位：分</span>
					</td>
				</tr>
				<tr>
					...
					<td><input name="favouableDesc" type="text"
						...
						maxlength="500" value="${favorable.favouableDesc}">
					</td>
				...
				<!-- <tr>
					...
					<td><select name="pastFlg" id="pastFlg"
						data-options="panelHeight:'auto',required:true,editable: false"
						class="easyui-combobox">
